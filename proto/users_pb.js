...
goog.exportSymbol('proto.users.Gender', null, global);
...
proto.users.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = /** @type {!proto.users.Gender} */ (reader.readEnum());
      msg.setGender(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!proto.users.Gender}
 */
proto.users.User.prototype.getGender = function() {
  return /** @type {!proto.users.Gender} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};


/**
 * @param {!proto.users.Gender} value
 * @return {!proto.users.User} returns this
 */
